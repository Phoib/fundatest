Feature:
    In order to check the layout of nieuwbouw
    As a developer 
...
Background:
    ...
    And I click on the link "Nieuwbouw"
...
Scenario: Make a search
    ...
    Then I expect that the title is "Nieuwbouw Nederland - Nieuwbouwprojecten in Nederland [funda]"
